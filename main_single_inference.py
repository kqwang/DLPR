...
from data_read import get_dataloader_for_test
...
def get_args():
    ...
    parser.add_option('-s', "--inference strategy", dest='strategy', default="CD", choices=["DD", "tPD", "CD"], help='inference strategy, DD, tPD, or CD')
